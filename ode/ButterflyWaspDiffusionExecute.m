%add nearest neighbor diffusion with Neumann BCs
clear all
...
params  = [m,c,d,g,N,mu]; %array of parameters to be passed into the ODE
...
[t,y]=ode45(@(t,y0) ButterflyWaspDiffusionModel(t,y0,params),t,y0) %run ODE
