...
A direct call for more attention to the role of variation in behavioural phenotype is given by Kortet, \textit{et al} \cite{doi:10.1111/j.1461-0248.2010.01536.x}. Their discussion is focused on the potential impact of variation in specific behaviour and provide a number of examples to motivate the importance of the phenomenon. They also discuss
some of the potential challenges to directly observing this variation. One specific example they give is the difficulty
seen in the capture of Pumpkin Seed
...
individuals based on an individual's level of boldness.
...
disease model by adding a convolution with a time delay.
...
within key individuals resulted in broader impacts across the colony. For example, they found the differences in
boldness impacted the prey capture rate for the colony. They also found that
the rules governing the distribution of aggression impacted the spread of disease across the broader population.
...
\end{eqnarray}
The corresponding discretization of the equation for the wasps is can be simplified because the moth population is defined on the Gauss-Labotto points,and the integral can be approximated as described above. A similar approach has been described by Parend \textit{et al}\cite{doi:10.1002/mma.1318}.
