...
\begin{eqnarray}
  ...
  Y(\origTheta) & = & r T_{\mathrm{search}}(\origTheta) \origB(t,\origTheta) \origP{\origTheta},
\end{eqnarray}
...
\begin{eqnarray}
  ...
  Y(\origTheta) & = & \frac{r T_{\mathrm{total}} \origB(t,\origTheta) \origP{\origTheta}}{1 + \beta r \origB(t,\origTheta) \origP{\origTheta}}.
\end{eqnarray}
...
\begin{eqnarray}
  ...
  \origGamma \cdot w(t) \frac{\origP{\origTheta} \origB(t,\origTheta) }{\origC +  \origP{\origTheta} \origB(t,\origTheta)},
\end{eqnarray}
...
\begin{eqnarray}
  ...
  \int^{\origL}_{\origTheta=0} \origG \cdot \origW(t) \frac{\origP{\origTheta} \origB(t,\origTheta) }{\origC + \origP{\origTheta} \origB(t,\origTheta)} ~ d\origTheta.
\end{eqnarray}
...
\begin{eqnarray}
  \label{eq:odePDE1}
  \frac{\partial}{\partial t} \origB(t,\origTheta) & = &
      \left[ \origAlpha \cdot \origP{\origTheta} \origB(t,\origTheta) (\origK - \origB(t,\origTheta)) \right]
      - \left[ \origGamma \cdot \origW(t) \frac{\origP{\origTheta} \origB(t,\origTheta)}{\origC+\origP{\origTheta}\origB(t,\origTheta)} \right]
      + \left[ \mu \frac{\partial^2}{\partial \origTheta^2} \origB(t,\origTheta)\right], \\
  \label{eq:odePDE2}
