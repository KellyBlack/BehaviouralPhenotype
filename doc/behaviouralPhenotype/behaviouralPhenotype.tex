...
density at the fixed point is $\frac{u}{p(\theta)}$. Our earlier assumption, equation (\ref{eqn:positivityRequirement}), requiring that the fixed point occurs in the first quadrant,  implying that
\begin{eqnarray}
